<?php
/**
 * DGCT RY Viikkokisakone
 * Copyright 2010 Janne Kotka
 *
 * This file is part of Viikkokisakone
...
<html>
    <head>
        <title>Viikkiskone Installation</title>
    </head>
    <body>
<?php
...
function DoInstall() {
    ...
    if (!mysql_select_db($_POST['db_db'])) return failed();
    success();
...
function InstallDB() {
    ...
    foreach ($queries as $query) {
        ...
        if (trim($query) == 'SHOW WARNINGS') continue;
...
<<<EOF
<{$q}php
/** viikkiskone configuration settings
